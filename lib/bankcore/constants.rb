...
module Bankcore
  module Constants
    ...
    # Check overdraft above this amount (cents) requires supervisor override
    CHECK_OVERDRAFT_OVERRIDE_THRESHOLD_CENTS = (ENV["CHECK_OVERDRAFT_OVERRIDE_THRESHOLD_CENTS"] || 5_000).to_i
  end
  ...
  CHECK_OVERDRAFT_OVERRIDE_THRESHOLD_CENTS = Constants::CHECK_OVERDRAFT_OVERRIDE_THRESHOLD_CENTS
